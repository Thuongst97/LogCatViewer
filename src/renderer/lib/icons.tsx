...
export function SlidersIcon({ size, color = 'currentColor', style }: IconProps) {
  return (
    <svg {...base(size)} fill="none" stroke={color} strokeWidth={1.8} strokeLinecap="round" style={style}>
      <line x1="4" y1="6" x2="20" y2="6" />
      <circle cx="9" cy="6" r="2" fill="var(--bg-panel)" />
      <line x1="4" y1="12" x2="20" y2="12" />
      <circle cx="15" cy="12" r="2" fill="var(--bg-panel)" />
      <line x1="4" y1="18" x2="20" y2="18" />
      <circle cx="9" cy="18" r="2" fill="var(--bg-panel)" />
    </svg>
  );
}
